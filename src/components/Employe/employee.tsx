...
const EmployeePrizePage: React.FC = () => {
    ...
    const handleSearchPrize = async () => {
        ...
        try {
            const response = await axios.post("https://pre-prod.dsp5-archi-o23-15m-g5.fr/api/get-user-tickets", {
                nom: name,
                email: email,
            });
    ...
    const handleClaimPrize = async (id_ticket: number) => {
        try {
            ...
            const response = await axios.put(
                `https://pre-prod.dsp5-archi-o23-15m-g5.fr/api/update-ticket-status/${id_ticket}`,
                requestData,
                {
                    headers: {
