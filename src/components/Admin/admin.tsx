...
const AdminPage: React.FC = () => {
  ...
  const handleExportData = async () => {
    try {
      const response = await axios.get('https://pre-prod.dsp5-archi-o23-15m-g5.fr/api/export-users', {
  ...
  const handleSendNotification = async () => {
    try {
      ...
      await axios.post("https://pre-prod.dsp5-archi-o23-15m-g5.fr/api/send-newsletter", notificationData);
