...
app.post('/login', async (req: Request, res: Response): Promise<void> => {
    ...
    try {
        ...
        const accessToken = jwt.sign(payload, secretKey, { expiresIn: '15m' }); // Shorter expiration, e.g., 15 minutes
        const refreshToken = jwt.sign(payload, secretKey, { expiresIn: '7d' }); // Longer expiration, e.g., 7 days
